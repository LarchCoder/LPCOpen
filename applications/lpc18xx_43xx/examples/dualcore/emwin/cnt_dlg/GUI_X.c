...
void GUI_X_Log     (const char *s) { GUI_USE_PARA(s); DEBUGSTR((char *)s);}
void GUI_X_Warn    (const char *s) { GUI_USE_PARA(s); DEBUGSTR((char *)s);}
void GUI_X_ErrorOut(const char *s) { GUI_USE_PARA(s); DEBUGSTR((char *)s);}
